...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		$theme_styles_karousel  = "/css/theme-karousel.css";
		$theme_styles_karousel_responsive = "/css/theme-karousel-responsive.css";
		...
		wp_enqueue_style( 'karousel-styles', get_template_directory_uri() . $theme_styles_karousel, array(), $css_version );
		wp_enqueue_style( 'karousel-styles-responsive', get_template_directory_uri() . $theme_styles_karousel_responsive, array(), $css_version );
